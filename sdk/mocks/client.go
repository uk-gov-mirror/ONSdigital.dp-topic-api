...
//			},
//			PutTopicPrivateFunc: func(ctx context.Context, reqHeaders sdk.Headers, id string, topicUpdate []byte) (*sdk.ResponseInfo, apiError.Error) {
//				panic("mock out the PutTopicPrivate method")
//			},
...
type ClienterMock struct {
	...
	// PutTopicPrivateFunc mocks the PutTopicPrivate method.
	PutTopicPrivateFunc func(ctx context.Context, reqHeaders sdk.Headers, id string, topicUpdate []byte) (*sdk.ResponseInfo, apiError.Error)
	...
	calls struct {
		...
		// PutTopicPrivate holds details about calls to the PutTopicPrivate method.
		PutTopicPrivate []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// ReqHeaders is the reqHeaders argument value.
			ReqHeaders sdk.Headers
			// ID is the id argument value.
			ID string
			// TopicUpdate is the topicUpdate argument value.
			TopicUpdate []byte
		}
		...
		// PutTopicStatePrivate holds details about calls to the PutTopicStatePrivate method.
		PutTopicStatePrivate []struct {
			// Ctx is the ctx argument value.
			Ctx context.Context
			// ReqHeaders is the reqHeaders argument value.
			ReqHeaders sdk.Headers
	...
	lockPutTopicPrivate        sync.RWMutex
	lockPutTopicReleasePrivate sync.RWMutex
	lockPutTopicStatePrivate   sync.RWMutex
...
func (mock *ClienterMock) PutTopicPrivate(ctx context.Context, reqHeaders sdk.Headers, id string, topicUpdate []byte) (*sdk.ResponseInfo, apiError.Error) {
	if mock.PutTopicPrivateFunc == nil {
		panic("ClienterMock.PutTopicPrivateFunc: method is nil but Clienter.PutTopicPrivate was just called")
	}
	callInfo := struct {
		Ctx         context.Context
		ReqHeaders  sdk.Headers
	...
	mock.lockPutTopicPrivate.Lock()
	mock.calls.PutTopicPrivate = append(mock.calls.PutTopicPrivate, callInfo)
	mock.lockPutTopicPrivate.Unlock()
	return mock.PutTopicPrivateFunc(ctx, reqHeaders, id, topicUpdate)
}

// PutTopicPrivateCalls gets all the calls that were made to PutTopicPrivate.
// Check the length with:
//
...
func (mock *ClienterMock) PutTopicPrivateCalls() []struct {
	...
	mock.lockPutTopicPrivate.RLock()
	calls = mock.calls.PutTopicPrivate
	mock.lockPutTopicPrivate.RUnlock()
	return calls
}
...
func (mock *ClienterMock) PutTopicStatePrivate(ctx context.Context, reqHeaders sdk.Headers, id string, topicState []byte) (*sdk.ResponseInfo, apiError.Error) {
	...
	mock.lockPutTopicStatePrivate.Lock()
	mock.calls.PutTopicStatePrivate = append(mock.calls.PutTopicStatePrivate, callInfo)
	mock.lockPutTopicStatePrivate.Unlock()
	return mock.PutTopicStatePrivateFunc(ctx, reqHeaders, id, topicState)
}

// PutTopicStatePrivateCalls gets all the calls that were made to PutTopicStatePrivate.
// Check the length with:
//
...
func (mock *ClienterMock) PutTopicStatePrivateCalls() []struct {
	...
	mock.lockPutTopicStatePrivate.RUnlock()
	return calls
}
